...
public class JsonUtils {
     ...
     * @throws IOException the io exception
     */
    public static <T> T parseJson(String jsonValue, TypeReference<T> typeReference) {
        Preconditions.checkArgument(StringUtils.isNotEmpty(jsonValue),
                "this argument is required; it must not be null");
        try {
    ...
    */
    public static String toJsonString(Object obj){
        JSONArray jsonObject = (JSONArray) JSONArray.toJSON(obj);
